...
The project does not use one single fio workload for every storage question. It uses several benchmark models, with each model chosen to answer a different architectural question.
