...
- Started: `2026-08-18T21:37:03Z`
- Ended: `2026-08-18T21:48:03Z`
...
| Metric | Result |
| --- | ---: |
| DATA read IOPS (all four jobs) | 33612.36 |
| DATA write IOPS (all four jobs) | 14395.16 |
| DATA total IOPS | 48007.52 |
| REDO write IOPS | 1164.37 |
| REDO write throughput (MiB/s) | 4.55 |
...
| Host CPU mean (%) | 37.63 |
| Mean FIO process CPU (%) | 9.95 |

## Per-job results

| Job | Read IOPS | Write IOPS | Read MiB/s | Write MiB/s | Write p99 ms | Write p99.9 ms |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `data-8k#1` | 8400.44 | 3600.70 | 65.63 | 28.13 | 15.663 | 20.054 |
| `data-8k#2` | 8405.40 | 3600.67 | 65.67 | 28.13 | 15.663 | 20.054 |
| `data-8k#3` | 8400.90 | 3596.83 | 65.63 | 28.10 | 15.663 | 20.054 |
| `data-8k#4` | 8405.63 | 3596.96 | 65.67 | 28.10 | 15.663 | 20.054 |
| `redo#5` | 0.00 | 1164.37 | 0.00 | 4.55 | 0.717 | 1.188 |
