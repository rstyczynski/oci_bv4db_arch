...
export SPRINT_LABEL="Sprint 10 Higher Performance Single"
export NAME_PREFIX="bv4db-oracle10-hp-single-run"
export RUN_LEVEL="integration"
export FIO_RUNTIME_SEC="${FIO_RUNTIME_SEC:-600}"
export STORAGE_LAYOUT_MODE="single_uhp"
export ARTIFACT_PREFIX="oracle-hp-single-4k-redo-integration"
export VPU_SINGLE="20"
